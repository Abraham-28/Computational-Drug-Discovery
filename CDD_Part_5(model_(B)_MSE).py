# -*- coding: utf-8 -*-
"""CDD_Part_5(model_(B)-MSE).ipynb

# Refer my google colab link for notebook file https://colab.research.google.com/drive/17L_bgbWlrC94TVdxEpTZtcBtHq-hu6gn#scrollTo=Z9oBfORwZX_n
...
#timestamp = eat_time.strftime("MSE_NS3_%Y%m%d_%I%M%S%p")  # %I = 12-hour clock, %p = AM/PM
#timestamp = eat_time.strftime("MSE_Ro5_%Y%m%d_%I%M%S%p")  # %I = 12-hour clock, %p = AM/PM
timestamp = eat_time.strftime("MSE_Clean_%Y%m%d_%I%M%S%p")  # %I = 12-hour clock, %p = AM/PM
